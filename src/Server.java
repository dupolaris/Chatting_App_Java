...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        //server title in header
        JLabel servertitle = new JLabel("Server");
        servertitle.setBounds(20, 20, 100, 30);
        servertitle.setForeground(Color.WHITE);
        servertitle.setFont(new Font("SAN_SERIF",Font.BOLD, 30 ));
        frameheader.add(servertitle);
            ...
            while(true){
               ...
               dout = new DataOutputStream(s.getOutputStream());
                ...
                while (true) {
                    ...
                    JPanel panel = formatLabel("Client: " + msg);
